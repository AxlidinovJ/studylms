    ...
    <form action="#" class="checkout-form">
            ...
            <div class="col-xs-12 col-md-6">
                ...
                <div class="form-group">
                    <label class="element-block fw-normal font-lato">
                        ...
                        <select data-placeholder="Country" class="chosen-select-no-single" style="display: none;">
                            <option value="0">England</option>
                            <option value="0">England</option>
                            <option value="0">England</option>
                        </select>
                        <div class="chosen-container chosen-container-single chosen-container-single-nosearch" title=""
                            style="width: 720px;"><a class="chosen-single">
                                <span>England</span>
                                <div><b></b></div>
                            </a>
        ...
        <div class="confirmation-box">
                ...
                <li>
                    ...
                    <div class="m-descr">
                        <p>Make your payment directly into our bank account. Please use your Order ID as the payment
                            reference. Your order won’t be shipped until the fun have cleared in our account.</p>
                    </div>
                </li>
                <li>
            ...
            <div class="text-right">
                <button type="submit" class="btn btn-warning btn-theme font-lato fw-bold text-uppercase">Place
                    Order</button>
            </div>
        </div>
    </form>
